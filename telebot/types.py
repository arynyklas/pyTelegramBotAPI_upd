...
class Update(JsonDeserializable):
    ...
    def __init__(
        self, update_id, message, edited_message, channel_post, edited_channel_post, inline_query,
        chosen_inline_result, callback_query, shipping_query, pre_checkout_query, poll, poll_answer
    ):
...
class WebhookInfo(JsonDeserializable):
    ...
    def __init__(
        self, url, has_custom_certificate, pending_update_count, last_error_date, last_error_message,
        max_connections, allowed_updates
    ):
        self.url = url
...
class User(JsonDeserializable, Dictionaryable, JsonSerializable):
    ...
    def de_json(cls, json_string):
        ...
        return cls(
            id, is_bot, first_name, last_name, username, language_code, can_join_groups, can_read_all_group_messages, supports_inline_queries
        )
...
class Chat(JsonDeserializable):
    ...
    def de_json(cls, json_string):
        ...
        return cls(
            ...
            all_members_are_administrators, photo, bio, description, invite_link,
...
class Message(JsonDeserializable):
    ...
    def de_json(cls, json_string):
        ...
        if 'proximity_alert_triggered' in obj:
            opts['proximity_alert_triggered'] = ProximityAlertTriggered.de_json(obj['ProximityAlertTriggered'])
            content_type = 'proximity_alert_triggered'

        return cls(
            message_id, from_user, sender_chat, date, chat,
            content_type, opts, json_string
        )
    ...
    def __init__(self, message_id, from_user, sender_chat, date, chat, content_type, options, json_string):
...
class Location(JsonDeserializable):
    ...
    def __init__(
        self, longitude, latitude, horizontal_accuracy, live_period,
        heading, proximity_alert_radius
    ):
...
class Venue(JsonDeserializable):
    ...
    def de_json(cls, json_string):
        ...
        return cls(
            location, title, address, foursquare_id, foursquare_type,
            google_place_id, google_place_type
        )

    def __init__(
        self, location, title, address, foursquare_id=None,
...
class ChatMember(JsonDeserializable):
    ...
    def de_json(cls, json_string):
        ...
        return cls(
            user, status, custom_title, is_anonymous, until_date, can_be_edited, can_post_messages,
    ...
    def __init__(
        self, user, status, custom_title=None, is_anonymous=None, until_date=None, can_be_edited=None,
...
class ChatPermissions(JsonDeserializable, JsonSerializable, Dictionaryable):
    def __init__(
        self, can_send_messages=None, can_send_media_messages=None,
...
class InputLocationMessageContent(Dictionaryable):
    def __init__(
        self, latitude, longitude, live_period=None, heading=None,
...
class InputVenueMessageContent(Dictionaryable):
    def __init__(
        self, latitude, longitude, title, address,
...
class InlineQueryResultLocation(JsonSerializable):
    def __init__(
        self, id, title, latitude, longitude, live_period=None, heading=None, reply_markup=None,
        input_message_content=None, thumb_url=None, thumb_width=None, thumb_height=None, proximity_alert_radius=None
    ):
        self.type = 'location'
        self.id = id
        self.title = title
    ...
    def to_json(self):
        json_dict = {
            'type': self.type, 'id': self.id, 'latitude': self.latitude, 'longitude': self.longitude,
            'title': self.title
        }
...
class InlineQueryResultVenue(JsonSerializable):
    def __init__(
        self, id, title, latitude, longitude, address,
        foursquare_id=None, foursquare_type=None,
        google_place_id=None, google_place_type=None,
        reply_markup=None, input_message_content=None,
...
class SuccessfulPayment(JsonDeserializable):
    ...
    def de_json(cls, json_string):
        ...
        return cls(
            currency, total_amount, invoice_payload, shipping_option_id, order_info,
...
class InputMediaDocument(InputMedia):
    def __init__(self, media, thumb=None, disable_content_type_detection=None, caption=None, parse_mode=None):
