...
class TeleBot:
    ...
    def __init__(
        ...
        :param skip_pending: skip recurring messages
    ...
    def process_middlewares(self, update):
        if len(self.typed_middleware_handlers.items()) > 0:
    ...
    def send_message(
        self, chat_id, text, disable_web_page_preview=None,
    ...
    def copy_message(
        self, chat_id, from_chat_id, message_id, caption=None,
        ...
        return apihelper.copy_message(
            self.token, chat_id, from_chat_id, message_id, caption,
    ...
    def forward_message(self, chat_id, from_chat_id, message_id, disable_notification=None, timeout=None):
        ...
        return types.Message.de_json(
            apihelper.forward_message(
                self.token, chat_id, from_chat_id, message_id, disable_notification, timeout
            )
        )
    ...
    def send_dice(
        ...
        return types.Message.de_json(
            apihelper.send_dice(
                ...
                allow_sending_without_reply, reply_markup, timeout
            )
        )

    def send_photo(
        self, chat_id, photo, caption=None, reply_to_message_id=None,
        allow_sending_without_reply=None, reply_markup=None,
        ...
        return types.Message.de_json(
            apihelper.send_photo(
                self.token, chat_id, photo, caption, reply_to_message_id,
                allow_sending_without_reply, reply_markup,
    ...
    def send_audio(
        self, chat_id, audio, caption=None, duration=None, performer=None, title=None,
    ...
    def send_voice(
        self, chat_id, voice, caption=None, duration=None, reply_to_message_id=None,
        ...
        return types.Message.de_json(
            apihelper.send_voice(
                self.token, chat_id, voice, caption, duration, reply_to_message_id,
                allow_sending_without_reply, reply_markup, parse_mode,
                disable_notification, timeout
            )
        )

    def send_document(
        self, chat_id, data, caption=None, reply_markup=None,
        parse_mode=None, disable_content_type_detection=None, disable_notification=None,
        reply_to_message_id=None, allow_sending_without_reply=None, timeout=None, thumb=None
    ):
        """
        ...
        return types.Message.de_json( 
            apihelper.send_data(
                self.token, chat_id, data, 'document', reply_markup, parse_mode,
                disable_content_type_detection, disable_notification,
                reply_to_message_id, allow_sending_without_reply, timeout,
                caption, thumb
            )
        )

    def send_sticker(
        self, chat_id, data, reply_to_message_id=None, allow_sending_without_reply=None,
        ...
        return types.Message.de_json(
            apihelper.send_data(
                self.token, chat_id, data, 'sticker', reply_markup,
                disable_notification, reply_to_message_id,
    ...
    def send_video(
        self, chat_id, data, duration=None, caption=None, reply_to_message_id=None,
        allow_sending_without_reply=None, reply_markup=None, parse_mode=None,
        ...
        return types.Message.de_json(
            apihelper.send_video(
                self.token, chat_id, data, duration, caption, reply_to_message_id,
                allow_sending_without_reply, reply_markup, parse_mode,
                supports_streaming, disable_notification, timeout, thumb,
                width, height
            )
        )

    def send_animation(
        self, chat_id, animation, duration=None, caption=None, reply_to_message_id=None,
        allow_sending_without_reply=None, reply_markup=None, parse_mode=None,
    ...
    def send_video_note(
        self, chat_id, data, duration=None, length=None,
        reply_to_message_id=None, allow_sending_without_reply=None,
        reply_markup=None, disable_notification=None, timeout=None, thumb=None
    ):
        """
        ...
        return types.Message.de_json(
            apihelper.send_video_note(
                self.token, chat_id, data, duration, length, reply_to_message_id,
                allow_sending_without_reply, reply_markup, disable_notification,
                timeout, thumb
            )
        )
    ...
    def send_location(
        self, chat_id, latitude, longitude, horizontal_accuracy=None, live_period=None,
        heading=None, proximity_alert_radius=None, reply_to_message_id=None,
        allow_sending_without_reply=None, reply_markup=None, disable_notification=None,
        timeout=None
    ):
        """
        ...
        return types.Message.de_json(
            apihelper.send_location(
                self.token, chat_id, latitude, longitude, horizontal_accuracy,
                live_period, heading, proximity_alert_radius, reply_to_message_id,
                allow_sending_without_reply, reply_markup, disable_notification, timeout
            )
        )

    def edit_message_live_location(
        self, latitude, longitude, chat_id=None, message_id=None,
    ...
    def send_venue(
        self, chat_id, latitude, longitude, title, address,
    ...
    def send_contact(
        self, chat_id, phone_number, first_name, last_name=None,
        disable_notification=None, reply_to_message_id=None,
        allow_sending_without_reply=None, reply_markup=None, timeout=None
    ):
        ...
        return types.Message.de_json(
            apihelper.send_contact(
                self.token, chat_id, phone_number, first_name, last_name,
                disable_notification, reply_to_message_id, allow_sending_without_reply,
                reply_markup, timeout
            )
        )
    ...
    def promote_chat_member(
        self, chat_id, user_id, is_anonymous=None, can_change_info=None,
        ...
        return apihelper.promote_chat_member(
            self.token, chat_id, is_anonymous, user_id, can_change_info,
    ...
    def get_my_commands(self):
        """
        Use this method to get the list of the bot's commands.
        :return: list of dicts with bot commands
        """

        return apihelper.get_my_commands(self.token)
    ...
    def unpin_chat_message(self, chat_id, message_id=None):
        """
        Use this method to unpin a message in chat.
        The bot must be an administrator in the chat for this to work and must have the appropriate admin rights.
        Returns True on success.
        :param chat_id: Int or Str: Unique identifier for the target chat or username of the target channel
            (in the format @channelusername)
    ...
    def unpin_all_chat_messages(self, chat_id):
        """
        Use this method to unpin all messages in chat.
        The bot must be an administrator in the chat for this to work and must have the appropriate admin rights.
        Returns True on success.
        :param chat_id: Int or Str: Unique identifier for the target chat or username of the target channel
            (in the format @channelusername)
    ...
    def edit_message_text(
        self, text, chat_id=None, message_id=None, inline_message_id=None, parse_mode=None,
    ...
    def set_game_score(
        self, user_id, score, force=None, chat_id=None, message_id=None, inline_message_id=None,
        edit_message=None
    ):
        """
        ...
        result = apihelper.set_game_score(
            self.token, user_id, score, force, chat_id, message_id, inline_message_id, edit_message
        )
    ...
    def send_invoice(
        self, chat_id, title, description, invoice_payload, provider_token, currency, prices,
        ...
        return types.Message.de_json(
            apihelper.send_invoice(
                ...
                reply_to_message_id, allow_sending_without_reply, reply_markup, provider_data, timeout
            )
        )
    ...
    def send_poll(
        ...
        is_closed=None, disable_notifications=False, reply_to_message_id=None,
        allow_sending_without_reply=None, reply_markup=None, timeout=None
    ):
        """
        Send polls
        ...
        return types.Message.de_json(
            apihelper.send_poll(
                self.token, chat_id, question, options, is_anonymous, type, allows_multiple_answers, correct_option_id,
    ...
    def edit_message_caption(
        self, caption, chat_id=None, message_id=None, inline_message_id=None,
        ...
        result = apihelper.edit_message_caption(
            self.token, caption, chat_id, message_id, inline_message_id,
    ...
    def answer_inline_query(
        ...
        return apihelper.answer_inline_query(
            self.token, inline_query_id, results, cache_time, is_personal, next_offset,
    ...
    def create_new_sticker_set(
        self, user_id, name, title, png_sticker, emojis, contains_masks=None,
        mask_position=None
    ):
        """
        ...
        return apihelper.create_new_sticker_set(
            self.token, user_id, name, title, png_sticker, emojis, contains_masks,
            mask_position
        )
